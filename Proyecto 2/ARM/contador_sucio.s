...
mensaje_resultado: .asciz "Números mayores a 150: %d\n"  // Mensaje para mostrar el resultado
...
_start:
    ...
    mov x20, #0          // Contador de números mayores a 150
...
bucle_analisis:
    ...
    fmov d1, #150.0
    fcmp d0, d1
    ble saltar_incremento  // Si es menor o igual a 150, no incrementar
    add x20, x20, #1     // Incrementar el contador si es mayor a 150
